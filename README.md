...
to set up first Odoo instance @ `localhost:10014` (default master password: `Admin1234.,`)
...
to set up another Odoo instance @ `localhost:11014` (default master password: `Admin1234.,`)
...
* Default database password (**admin_passwd**) is `Admin1234.,`, please change it @ [etc/odoo.conf#L60](/etc/odoo.conf#L60)
